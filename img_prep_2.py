            ...
            if x >= 20 and x < width - 20:
                for column_start, column_end in selected_columns:
                    if x >= column_start and x < column_end:
                        ...
                        region_index = x // region_width

                        # Calculate the midpoint of the selected column within the region
                        region_midpoint = (column_start + column_end) // 2 - region_index * region_width
                        ...
                        pixel_left = input_image.getpixel((region_index * region_width + region_midpoint - left_pixels, y))
                        pixel_right = input_image.getpixel((region_index * region_width + region_midpoint + right_pixels, y))
...
output_filename = "distorted_2.ppm"
